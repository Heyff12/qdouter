...
import lost_merchant from '../pages/forms/lost_merchant' //流失商户统计
...
import addNotice from '../pages/notice/add' //新增公告
import material from '../pages/material/index' //培训资料
import no_merchant from '../pages/nocard/merchant' //设置商户默认费率
import busycircle from '../pages/busycircle/index' //商圈管理
import alliance from '../pages/alliance/index' //商圈联盟
...
export default [
    ...
    { path: '/lost_merchant', name: 'lost_merchant', component: lost_merchant },
    //结算管理
    ...
    { path: '/no_merchant', name: 'no_merchant', component: no_merchant },
    { path: '/busycircle', name: 'busycircle', component: busycircle },
    { path: '/alliance', name: 'alliance', component: alliance },
]
