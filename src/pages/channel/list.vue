  ...
  <div>
    ...
    <div class="right_body">
      <el-form label-width="100px" class="demo-ruleForm" :model="searchkey" :rules="searchkey_rule" ref="searchkey">
        <el-row :gutter="10">
          ...
          <el-col :xs="24" :sm="24" :md="12" :lg="6">
            <el-form-item :label="$t('generalPro.searchBank.qdStatus')">
              <el-select v-model="searchkey.status">
                ...
                <el-option :label="$t('generalPro.searchBank.frozen')" value="1"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="24" :md="12" :lg="6">
          ...
          <el-col :xs="24" :sm="24" :md="12" :lg="6">
              <el-form-item :label="$t('generalPro.bodyBank.authCity2')+'：'" prop="auth_city">
                  <el-input v-model.trim="searchkey.auth_city"></el-input>
              </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="24" :md="12" :lg="6">
        ...
        <el-table :data="channels_now" border stripe style="width: 100%">
          ...
          <el-table-column :label="$t('generalPro.bodyBank.qdStatus')" resizable>
            <template scope="scope">
              <span v-if="scope.row.base.status">{{$t('generalPro.searchBank.frozen')}}</span>
          ...
          <el-table-column :label="$t('app.operate')" resizable min-width="100px">
            <template scope="scope">
              <span v-if="scope.row.base.status"><el-button type="info" @click="open_chan(scope.row.base)">{{$t('generalPro.bodyBank.unfrozen')}}</el-button></span>
              <span v-else><el-button type="warning" @click="stop_chan(scope.row.base)">{{$t('generalPro.bodyBank.frozen')}}</el-button></span>
            </template>
          </el-table-column>
    ...
    <bounced :visible="opratedialog">
      <p class="bounced_text">
        {{$t('channelList.bodyBank.tipS')}} <i class="orange" v-if="oprate_if">{{$t('generalPro.bodyBank.unfrozen')}}</i><i class="orange" v-else>{{$t('generalPro.bodyBank.frozen')}}</i> {{$t('channelList.bodyBank.tipE')}}？
      </p>
      <p slot="footer">
