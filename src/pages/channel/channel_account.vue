<template>
    <div>
        <div class="right_head">
            {{$t('generalPro.bodyBank.accountInfo')}}
        </div>
                ...
                <el-row>
                    <div class="step_show">
                        <el-col :xs="24" :sm="24" :md="12" :lg="8">
                            <el-form-item :label="$t('generalPro.bodyBank.getMoneyName')" prop="bankuser">
                                <el-input v-model="account.bankuser" :disabled="true"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="24" :md="12" :lg="8">
                            <el-form-item :label="$t('generalPro.bodyBank.bankAccount')" prop="bankaccount">
                                <el-input v-model="account.bankaccount" :disabled="true"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :xs="24" :sm="24" :md="12" :lg="8">
                            <el-form-item :label="$t('generalPro.bodyBank.headBank')" prop="headbankname">
                                <el-select v-model="account.headbankname" disabled>
                        ...
                        <el-col :xs="24" :sm="24" :md="12" :lg="8">
                            <el-form-item :label="$t('generalPro.bodyBank.bankName')" prop="bankname">
                        ...
                        <el-col :xs="24" :sm="24" :md="12" :lg="8">
                            <el-form-item :label="$t('generalPro.bodyBank.settleStyle')" prop="banktype">
                                <el-select v-model.number="account.banktype" disabled>
                        ...
                        <el-col :xs="24" :sm="24" :md="12" :lg="8">
                            <el-form-item :label="$t('generalPro.bodyBank.settleMothod')" prop="settle_cycle">
                                <el-select v-model.number="account.settle_cycle" disabled>
                        ...
                        <el-col :xs="24" :sm="24" :md="12" :lg="8">
                            <el-form-item :label="$t('generalPro.bodyBank.wechartFee')" prop="wechat_fee">
                        ...
                        <el-col :xs="24" :sm="24" :md="12" :lg="8">
                            <el-form-item :label="$t('generalPro.bodyBank.zfbFee')" prop="alipay_fee">
                        ...
                        <el-col :xs="24" :sm="24" :md="12" :lg="8">
                            <el-form-item :label="$t('generalPro.bodyBank.qqFee')" prop="qqwallet_fee">
                        ...
                        <el-col :xs="24" :sm="24" :md="12" :lg="8">
                            <el-form-item :label="$t('generalPro.bodyBank.jdFee')" prop="jd_fee">
                        ...
                        <el-col :xs="24" :sm="24" :md="12" :lg="8">
                            <el-form-item :label="$t('generalPro.bodyBank.cardFee')" prop="swipecard_fee">
                        ...
                        <el-col :xs="24" :sm="24" :md="12" :lg="8">
                            <el-form-item :label="$t('generalPro.bodyBank.defaultFee')" prop="default_mchnt_fee">
...
export default {
        ...
        var check_fee = (rule, value, callback) => {
            ...
            setTimeout(() => {
                if (!reg.test(value)) {
                    ...
                    callback(new Error('商户默认费率最低0.25%， 即≥0.25'));
                } else {
                    callback();
                }
            }, 100);
    ...
    methods: {
        ...
        get_cycle: function() {
            var _this = this;
            this.$ajax_log.ajax_get(this, this.qd_cycle_url, '', (data_return) => {
        ...
        get_branchbank: function(post_data) {
            var _this = this;
            this.$ajax_log.ajax_get(this, this.qd_branchbanks_url, post_data, (data_return) => {
