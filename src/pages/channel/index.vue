              ...
              <el-row :gutter="20">
                ...
                <el-col :xs="24" :sm="24" :md="12" :lg="8">
                  <el-form-item label="登录名" prop="username">
                    <el-input v-model="base.username" placeholder="渠道系统的登录账号以及渠道识别码"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :xs="24" :sm="24" :md="12" :lg="8">
                ...
                <el-col :xs="24" :sm="24" :md="12" :lg="8">
                  <el-form-item label="联系方式" prop="mobile">
                    <el-input v-model="base.mobile" placeholder="方便后期联系"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :xs="24" :sm="24" :md="12" :lg="8">
...
export default {
  ...
  created: function() {
    ...
    this.username_pre = this.base.username;
  ...
  methods: {
    ...
    one_next(formName) {
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          if (_this.email_pre !== _this.base.email || _this.username_pre !== _this.base.username || _this.idnumber_pre !== _this.base.legal_idnumber) {
            _this.get_userid();
          } else {
            _this.showli_one2();
            _this.one_over = true;
      ...
      this.$http.post(_this.userid_url, post_data, {
        ...
        .then(function(response) {
          ...
          if (data_return.respcd == '0000') {
            ...
            _this.username_pre = _this.base.username;
