...
export default {
  ...
  yanzheng: {
    ...
    SalesName:"请输入手机号",
    merStyle:"请输入商户类型，长度在 2 到 4 个数字",
    contact:"请输入联系人，长度在 1 到 128 个字符",
    contactEmail:"请填写正确的联系人邮箱",
    bank:"请输入收款银行，长度在 1 到 50 个字符",
    branch:"请输入分行，长度在 1 到 256 个字符",
    bankcode:"请输入开户账号，长度在 1 到 256 个字符",
    bankcode1:"请输入开户账户，长度在 1 到 256 个字符",
    bankNum:"请输入收款账号，长度在 1 到 256 个字符",
    swift:"请输入联行号，长度在 1 到 50 个字符",
    rule:"请输入清算规则，长度在 1 到 9 个数字",
    fee: "请填写正确的费率"
  },
  login: {
    qdSystem: "渠道系统",
