...
export default new Vuex.Store({
  ...
  mutations: {
    ...
    t_qudao_name(state, name) { //渠道名称--info--name获取后，设置
      state.qudao_name = name;
    },
    ...
    t_qd_level(state, obj) {
      state.qd_level = obj;
    },
    t_qd_country(state, obj) {
      state.qd_country = obj;
    },
    ...
    t_if_alliance(state, obj) {
      state.if_alliance = obj;
    },
  }
});
//判断是否是登录页
